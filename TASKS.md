...
| T2026-0429-I | 🔴 高 | 体験 | **keyPoint 100字未満トピックのランキング降格** — 要約なし（keyPoint が空 or 100字未満）のトピックが上位に浮上している（PO報告: c0ccd7d87d35f1f1, 369af39fcf0c42b4 等）。原因: ランキングスコアが keyPoint 充填を考慮していない。対応: app.js の sort ロジックに keyPoint 充填ペナルティを追加（keyPoint 空 or 50字未満 → score × 0.3 降格）。T2026-0429-H（Lambda修正）完了後に合わせて検証。 | frontend/app.js | 2026-04-29 |
