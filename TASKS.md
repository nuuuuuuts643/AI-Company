...
|---|---|---|---|---|
| T004 | 低 | **セッション自動ロール判定の追加**（ナオヤ指示）。CLAUDE.md のセッション開始時に「WORKING.mdに何も書かれていない場合はfinderロールで動作する / 書かれている場合は空きタスクを取るimplementerロールで動作する」というルールを追加 | CLAUDE.md | 2026-04-26 |
