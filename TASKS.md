...
| T2026-0501-SLI-KP | 🟡 中 | AI品質 | **keyPoint 充填率低下アラート: 2026-05-01 (topics.json 38.6% < 50% 閾値・目標 70%)** — scheduled task `p003-sli-morning-check` (08:03 JST) 自動巡回で検出。228件中 88件のみ keyPoint>=50字。フェーズ2 完了条件 (70%) 未達状態の継続観測。05:30 JST processor 後の WORKING.md SLI 実測との差分要確認 (公開topics-card.json: kp>=100字 35.7% / topics.json: kp>=50字 38.6%)。 | (観測のみ) | 2026-05-01 |
