...
| T167 | 低 | **about.html FAQ のAI処理時刻が実際と異なる** — 根本原因: FAQに「JST 0時・7時・12時・18時」と書かれているが、実際のprocessor実行スケジュールはJST 01:00/07:00/13:00/19:00。修正方法: FAQ `acceptedAnswer` の時刻テキストを正確な時刻に修正（0→01:00、12→13:00、18→19:00）。 | `frontend/about.html` | 2026-04-27 |
