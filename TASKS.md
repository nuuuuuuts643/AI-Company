...
| T2026-0429-L | 🔴 高 | AI品質 | **velocityScore / スコア減衰の検証・修正** — 古いトピックが「急上昇」として上位表示されている（PO確認）。スコア減衰が機能していない可能性。対応: (a) proc_storage.py or app.js の velocityScore 計算ロジック確認（時間経過でスコアが下がるか） (b) 減衰係数・半減期の設定値確認 (c) 古いトピック（publishedAt > 48h）が上位に出ないよう時間減衰を強化。目標: publishedAt から 48h 経過したトピックの表示順は新着トピックに比べ大幅に下がる | lambda/processor/proc_storage.py, frontend/app.js | 2026-04-29 |
