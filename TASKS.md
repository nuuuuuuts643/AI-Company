...
| T2026-0429-J | 🔴 高 | AI品質 | **keyPoint ≥100字 充填率 70% 達成（プロンプト強化）** — 現状: keyPoint 任意長 84.40% に対し ≥100字 1.83%。200〜300字指示が守られていない。対応: (a) proc_ai.py の keyPoint プロンプトに文字数カウント例示を追加・「必ず200字以上」を強調 (b) Lambda 実行後に scripts/verify_keypoint_length.py（新設）で充填率を測定し 70% 以上を確認。T2026-0429-H（Lambda復旧）完了後に実施。 | lambda/processor/proc_ai.py, scripts/ | 2026-04-29 |
