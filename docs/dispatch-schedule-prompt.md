...
```
1. cat ~/ai-company/WORKING.md
2. cat ~/ai-company/TASKS.md （フェーズ2タスク確認）
3. head -55 ~/ai-company/docs/project-phases.md（フェーズ2完了条件確認）
```
...
```
P003 Flotopic プロジェクト。~/ai-company が作業ディレクトリ。
