...
| Slack Bot Token `***REDACTED-SEC3***...` | 同 commit 群 | revoked ✓ |
...
git log --all -p | grep -cE 'ghp_LyAq|ghp_JPS5|***REDACTED-SEC3***23616|B0AUJ9K64KE|B0AU4TV0M60|ntn_3865|***REDACTED-SEC3***'
# → 0 が表示されれば成功
```
...
- [ ] `git log --all -p | grep -E "ghp_LyAq|ghp_JPS5|***REDACTED-SEC3***|B0AUJ9K64KE|ntn_3865|***REDACTED-SEC3***"` が 0 件
