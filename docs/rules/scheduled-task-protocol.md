...
1. `cat /Users/murakaminaoya/ai-company/CLAUDE.md` — 絶対ルール
2. `bash /Users/murakaminaoya/ai-company/scripts/session_bootstrap.sh` — 起動チェック
3. `cat /Users/murakaminaoya/ai-company/docs/system-status.md` — 現状スナップショット
4. **本ファイル** — schedule-task の動作プロトコル
5. `cat /Users/murakaminaoya/ai-company/TASKS.md` — 最優先 unblocked タスク
