  ...
  --policy-document '{
    ...
    "Statement":[
      {"Sid":"DynamoDBSpecificTables","Effect":"Allow",
       ...
       "Resource":["arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/p003-topics","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/p003-topics/index/*","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/ai-company-comments","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/ai-company-comments/index/*","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/flotopic-analytics","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/flotopic-favorites","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/flotopic-rate-limits","arn:aws:dynamodb:ap-northeast-1:'"${ACCOUNT_ID}"':table/flotopic-users"]},
...
# Processor: 1日2回 JST 05:30 / 17:30 (2026-04-29 T2026-0429-P 朝刊・夕刊タイミング)
