...
RSS_FEEDS = [
    ...
    # 判定: ⚠️ Google News同様グレーゾーン→ 残す
    {'url': 'https://news.google.com/rss/search?q=%E3%82%B0%E3%83%AB%E3%83%A1+%E3%83%AC%E3%82%B9%E3%83%88%E3%83%A9%E3%83%B3+%E6%97%A5%E6%9C%AC&hl=ja&gl=JP&ceid=JP:ja',   'genre': '総合', 'tier': 3},
    {'url': 'https://news.google.com/rss/search?q=%E6%96%99%E7%90%86+%E3%83%AC%E3%82%B7%E3%83%94+%E9%A3%9F%E4%BA%8B&hl=ja&gl=JP&ceid=JP:ja',                              'genre': '総合', 'tier': 3},
    {'url': 'https://news.google.com/rss/search?q=%E3%83%95%E3%82%A1%E3%83%83%E3%82%B7%E3%83%A7%E3%83%B3+%E3%83%88%E3%83%AC%E3%83%B3%E3%83%89+%E3%83%96%E3%83%A9%E3%83%B3%E3%83%89&hl=ja&gl=JP&ceid=JP:ja', 'genre': '総合', 'tier': 3},
    {'url': 'https://news.google.com/rss/search?q=%E7%BE%8E%E5%AE%B9+%E3%82%B3%E3%82%B9%E3%83%A1+%E3%82%B9%E3%82%AD%E3%83%B3%E3%82%B1%E3%82%A2&hl=ja&gl=JP&ceid=JP:ja',  'genre': '総合', 'tier': 3},
]
...
GENRE_KEYWORDS = {
    ...
    'グルメ':  ['グルメ','料理','レシピ','レストラン','ラーメン','居酒屋','スイーツ','カフェ','食べ歩き','ランチ','ディナー','食品','食事','弁当','グルメ情報','食べログ','ミシュラン','飲食','食材','調理'],
    ...
    'スポーツ':  ['野球','サッカー','テニス','ゴルフ','バスケ','陸上','水泳','五輪','オリンピック','ワールドカップ','Ｊリーグ','プロ野球','NFL','NBA','相撲','ラグビー','大谷','錦織','W杯','Jリーグ','ボクシング','格闘技','UFC','MMA'],
    ...
    '国際':    ['米国','アメリカ','中国','ロシア','ウクライナ','EU','NATO','国連','外相','首脳','制裁','イラン','イスラエル','中東','北朝鮮','台湾','韓国','欧州','大統領','外務省','ミサイル','核','軍事','爆撃','戦争'],
}
...
GENRE_PRIORITY = ['国際','政治','スポーツ','健康','テクノロジー','株・金融','ビジネス','社会','科学','エンタメ','グルメ','くらし','ファッション']
