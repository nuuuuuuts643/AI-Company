...
JACCARD_THRESHOLD = 0.28  # 2026-04-28: 0.35 → 0.28 に緩和（クラスタ過分割T212対策。共通語率28%で統合）
MAX_CLUSTER_SIZE  = 15
...
SYNONYMS = {
    'アメリカ':'米国','米':'米国','usa':'米国','us':'米国','米大統領':'米国大統領',
    '総理':'首相','内閣総理大臣':'首相','総理大臣':'首相',
    '円相場':'為替','ドル円':'為替','ドル':'米国',
    '利上げ':'金利','利下げ':'金利',
    'オリンピック':'五輪','olympic':'五輪','オリンピック開催':'五輪',
    'chatgpt':'ai','gpt':'ai','claude':'ai','gemini':'ai','chatgpt4':'ai',
    # 人物エイリアス（T212対策: 同じ人物の異なる表記を統一）
    'トランプ':'トランプ大統領','donald':'トランプ大統領','trump':'トランプ大統領',
    'プーチン':'プーチン大統領','vladimir':'プーチン大統領',
    '習近平':'習近平国家主席','xi':'習近平国家主席',
    '岸田':'岸田首相','岸田文雄':'岸田首相',
    # 事件・事故系
    '発砲':'銃撃','射撃':'銃撃','乱射':'銃撃','銃乱射':'銃撃',
    '爆発物':'爆発','爆破':'爆発','爆発事故':'爆発','爆弾':'爆発',
    'テロ攻撃':'テロ','テロ事件':'テロ','テロ':'テロ',
    'サイバー攻撃':'ハッキング','不正アクセス':'ハッキング','ハッキング':'ハッキング',
    '墜落':'航空事故','衝突事故':'衝突','航空機':'航空',
    # 政治・外交
    '大統領府':'ホワイトハウス','米大統領府':'ホワイトハウス','白宮':'ホワイトハウス',
    '首脳会談':'サミット','g7サミット':'サミット','g20サミット':'サミット','サミット':'サミット',
    '経済制裁':'制裁','追加制裁':'制裁','制裁':'制裁',
    '訪問':'訪問','訪米':'訪米','訪中':'訪中','訪欧':'訪欧',
    # 経済・物価
    '値上げ':'物価','インフレ':'物価','物価上昇':'物価','デフレ':'物価',
    '円安進行':'円安','円安':'円安','円高進行':'円高','円高':'円高',
    '株価':'株','株式':'株','日経平均':'株',
    # 災害・気象
    '震度':'地震','マグニチュード':'地震','余震':'地震','地震':'地震',
    '台風接近':'台風','上陸':'台風','台風':'台風','暴風':'台風',
    '洪水':'水害','豪雨':'水害','水害':'水害','土砂':'土砂崩れ',
    # 医療・健康
    'ワクチン接種':'ワクチン','コロナワクチン':'ワクチン','mRNA':'ワクチン',
    '感染症':'感染','感染':'感染','新型コロナ':'感染症',
}
