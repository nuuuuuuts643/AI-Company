...
_GENRE_KEYPOINT_HINTS = {
    ...
    'テクノロジー': '性能差 (既存比)・採用速度・規制リスク・競合製品名 を keyPoint の中心数値/固有名詞に据える（逆説ヒント: 「実は〇〇倍速かった」「意外にも規制側が推進に転換」）',
    ...
    'エンタメ':     '話題性・興行成績・反響規模・関係者の反応 を keyPoint の中心数値/固有名詞に据える（逆説ヒント: 「無名作品が〇〇億円突破した理由は〜」「意外にも〇〇が批判的な反応を示した」）',
