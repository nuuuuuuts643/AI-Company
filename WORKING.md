...
| タスク名 | 種別 | 変更予定ファイル | 開始 JST | needs-push |
|---|---|---|---|---|
| [Code] T2026-0502-Z DAU/WAU メトリクス計測インフラ | Code | lambda/tracker/handler.py, scripts/sli_user_metrics.py, .github/workflows/freshness-check.yml | 2026-05-03 09:00 | yes |
