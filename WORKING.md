...
| タスク名 | 種別 | 変更予定ファイル | 開始 JST | needs-push |
|---|---|---|---|---|
| [Code] ARCH-AUDIT-D remove dead DynamoDB resources + fix _PROC_INTERNAL duplicate | Code | projects/P003-news-timeline/deploy.sh, lambda/handler.py, .github/workflows/*.md | 2026-05-03 15:45 JST | yes |
