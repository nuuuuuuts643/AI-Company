...
| Bluesky 自動投稿 | ⏸ 停止中 | 2026-04-26 | 運営エージェント全停止(2026-04-24)に伴い停止。scripts/bluesky_agent.py 存在。Lambda/EventBridgeなし |
...
- **Amazonアソシエイト申請**（PO手動）→ 申請後 `config.js` の `AFFILIATE_AMAZON_TAG` は設定済み（flotopic-22）
