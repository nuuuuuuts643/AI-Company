...
| 静的SEO HTML生成 | ✅ 本番稼働 | 2026-04-26 | topics/{tid}.html **500/500件**生成済み（T087補完後）。NoSuchKeyはスキップ扱い |
| Slack通知 | ✅ 修正済み | 2026-04-26 | T081: SLACK_WEBHOOK_URL→SLACK_WEBHOOK + continue-on-error:true追加 |
| filter-weights.json | ✅ ロード確認済み | 2026-04-26 | 28パターン正常ロード確認（fetcher log: "filter-weights.json ロード完了: 28パターン"） |
| lifecycle Lambda | ✅ 週次自動実行 | 2026-04-26 | ARCHIVE_DAYS=7・ゾンビ削除・S3孤立ファイル削除・topics/*.html孤立HTML削除(T091) |
...
| admin GET /contacts | ✅ 修正済み | 2026-04-26 | T090: Lambda invoke権限をGET/contacts・POST/contacts/resolveに追加。403(認証要)で正常動作確認 |
| _GW変数 | ✅ 修正済み | 2026-04-26 | T086: config.jsに`const _GW = _APIGW;`追加。app.js:992のDynamoDBフォールバックが有効になった |
