...
|---|---|---|---|---|
| SecurityAI | scripts/security_agent.py | push時(L1/L2) + 毎週月曜8:00 JST(L3) | 🟡 push待ち | Slack（CRITICAL時はPOさん直報） |
| LegalAI | scripts/legal_agent.py | push時(L2) + 毎月1日(L3) | 🟡 push待ち | Slack（要対応時はPOさん直報） |
| AuditAI | scripts/audit_agent.py | push時 + 週次 | 🟡 push待ち | **POさん直接報告（CEOを経由しない）** |
...
GITHUB_TOKEN="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" \
SLACK_BOT_TOKEN="xoxb-8970641423616-10995291739264-bNUcli9Op3eos6H9tHCDDMMF" \
SLACK_WEBHOOK="https://hooks.slack.com/services/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" \
