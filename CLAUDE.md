...
| AI要約カバレッジ | 📈 改善中 | 2026-04-26 | summary75%(379/500)・storyPhase50%(254/500)・imageUrl68%(341/500) |
| DynamoDB SNAP | 📉 改善中 | 2026-04-26 | ~808K件。TTL(7日)ENABLED。lifecycle週次削除（月曜02:00 UTC） |
| Bluesky 自動投稿 | ⏳ 実投稿待ち | 2026-04-26 | dry-run(18:22 JST)で正常確認。08:07 UTC実行はT075修正前で失敗。次スケジュール(JST 08:00 翌日=UTC 23:00)で初実投稿予定 |
| 静的SEO HTML生成 | ✅ 本番稼働 | 2026-04-26 | topics/{tid}.html **500/500件**生成済み（T087補完後） |
| お問い合わせフォーム | ⏳ DNS伝播待ち | 2026-04-26 | flotopic.com DKIM CNAME×3追加済み。伝播後に本番アクセス申請が必要 |
| 安定コンポーネント群 | ✅ 全稼働 | 2026-04-26 | sw.js(SHA自動注入)・CloudFront・sitemap・Slack・filter-weights・lifecycle(T091 HTML孤立削除追加)・アフィリエイト基盤・ストーリー表示・ジャンル分類(T085)・アフィリエイトKW(T084)・admin/contacts(T090)・_GW変数(T086) |
