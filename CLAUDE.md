...
| processor AI要約 | ✅ 稼働中 | 2026-04-26 | 4x/day自動実行。generatedSummary: ~95%・storyTimeline: ~90%・imageUrl: ~80% |
| AI要約カバレッジ | 📈 改善中 | 2026-04-26 | summary77%(252/324)・phase68%・imageUrl67%。公開トピック数増加で比率低下中 |
...
| アフィリエイト収益化基盤 | ✅ 実装済み | 2026-04-26 | AFFILIATE_AMAZON_TAG/RAKUTEN_IDをconfig.jsに設定するだけで稼働 |
| お問い合わせフォーム | ⏳ SES待ち | 2026-04-26 | contact.html → p003-contact Lambda。SES検証はPO手動作業が必要 |
