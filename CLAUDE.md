...
| Bluesky 自動投稿 | ✅ 修正済み | 2026-04-26 | T075でS3_BUCKET修正。静的HTML 489/500件(97%)確認。次回JST 08:00/12:00/18:00スケジュール実行で投稿可能 |
| 静的SEO HTML生成 | ✅ 本番稼働 | 2026-04-26 | topics/{tid}.html 489/500件(97%)生成済み。batch_generate_static_htmlをtopics.jsonベースに修正 |
